...
//   createNewChat: () => void;
//   deleteChat: (chatId: string) => void; // Add deleteChat prop
// }

// export function ChatSidebar({ chats, loadChat, createNewChat, deleteChat }: SidebarProps) {
...
//               />
//               {chats.map((chat) => (
//                 <div key={chat.chatId} className="flex items-center justify-between"> {/* Use a flex container */}
//                   <SidebarLink
//                     link={{
//                       label: chat.title,
//                       href: "#",
//                       icon: <IconMessage2 className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />,
//                       id: chat.chatId, // Add id prop to the link
//                     }}
//                     onClick={(e) => {
//                       e.preventDefault();
...
// // ... (Logo and LogoIcon components - no changes needed) ...
// export const Logo = () => {
//     return (
//       <Link
//         href="#"
                    ...
                    <div className="flex-grow" >
                        ...
                        {editingChatId === chat.chatId ? (
                            <input
                                ...
                                className="bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 border rounded px-1 py-0.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
                            />
                        ) : (
